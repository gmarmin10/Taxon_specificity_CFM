...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    Cnbiosynth=1*4.34728279914354E-10        #(molN cell-1 s) Constant for varible part of biosynthesis protein nitrogen (193-37)
...
#     NP=NP[5:]
    ...
    N_pigment_m=array([ N_pigment[4], N_pigment[11], N_pigment[24], N_pigment[119], N_pigment[359]])
    N_protein_m=array([N_protein[4],N_protein[11],N_protein[24],N_protein[119],N_protein[359]])
    N_RNA_m=array([N_RNA[4],N_RNA[11],N_RNA[24],N_RNA[119],N_RNA[359]])
    N_DNA_m=array([N_DNA[4],N_DNA[11],N_DNA[24],N_DNA[119],N_DNA[359]])
    ...
    N_pigment_d=array([N_data_pig[2],N_data_pig[6],N_data_pig[9],N_data_pig[11],N_data_pig[14]])
    N_protein_d=array([N_data_pro[2],N_data_pro[6],N_data_pro[9],N_data_pro[11],N_data_pro[14]])
    N_RNA_d=array([N_data_RNA[2],N_data_RNA[6],N_data_RNA[9],N_data_RNA[11],N_data_RNA[14]])
    N_DNA_d=array([N_data_DNA[2],N_data_DNA[6],N_data_DNA[9],N_data_DNA[11],N_data_DNA[14]])
