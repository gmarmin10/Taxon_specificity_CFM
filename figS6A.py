...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    Cnbiosynth=0.05*4.34728279914354E-10        #(molN cell-1 s) Constant for varible part of biosynthesis protein nitrogen (193-37)
    ...
    Cnrna_variable=7*6212.59249917364        #(s) Constant for Variable part of RNA (193-26)
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    RNA_Cmari=RNA_mari*(10.7/15.5)
    DNA_Cmari=DNA_mari*(11.1/15.9)
    Pro_Cmari=Pro_mari*(4.49/5.49)
    Pig_Cmari=Pig_mari*(55/59)
    Carb_Cmari=Carb_mari
    Lip_Cmari=Lip_mari-Pinlipid_mari
    ...
    RNA_Pmari=RNA_mari*(1/15.5)
    DNA_Pmari=DNA_mari*(1/15.9)
    Lip_Pmari=Pinlipid_mari
    Res_Pmari=poly_mari
    ...
    for i in arange(Growt):
        ...
        #########################
        mari_RNA_Pplot[i] = RNA_Pmari[j]
        mari_DNA_Pplot[i] = DNA_Pmari[j]
        mari_Lip_Pplot[i] = Lip_Pmari[j]
        mari_Res_Pplot[i] = Res_Pmari[j]
        gr_mari[j] = 1e30        
    ...
    N_pigment_m=array([ N_pigment[0], N_pigment[175], N_pigment[395], N_pigment[633], N_pigment[665]])
    N_protein_m=array([N_protein[0],N_protein[175],N_protein[395],N_protein[633],N_protein[665]])
    N_RNA_m=array([N_RNA[0],N_RNA[175],N_RNA[395],N_RNA[633],N_RNA[665]])
    N_DNA_m=array([N_DNA[0],N_DNA[175],N_DNA[395],N_DNA[633],N_DNA[665]])
     
    #observations
    N_data_pig=mari_Pig_Nplot*mari_NC
    N_data_pro=mari_Pro_Nplot*mari_NC
    N_data_RNA=mari_RNA_Nplot*mari_NC
    N_data_DNA=mari_DNA_Nplot*mari_NC
    #print(N_data_pro)

    N_pigment_d=array([N_data_pig[3],N_data_pig[7],N_data_pig[10],N_data_pig[12],N_data_pig[14]])
    N_protein_d=array([N_data_pro[3],N_data_pro[7],N_data_pro[10],N_data_pro[12],N_data_pro[14]])
    N_RNA_d=array([N_data_RNA[3],N_data_RNA[7],N_data_RNA[10],N_data_RNA[12],N_data_RNA[14]])
    N_DNA_d=array([N_data_DNA[3],N_data_DNA[7],N_data_DNA[10],N_data_DNA[12],N_data_DNA[14]])
