...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    Cnbiosynth=0.7*4.34728279914354E-10        #(molN cell-1 s) Constant for varible part of biosynthesis protein nitrogen (193-37)
    Nconst_protein=0.05*4.45336898828389E-15     #(molN cell-1) Constant protein pool in nitrogen (193-25)
    Nstore_max=2.91679384515998E-15         #(molN cell-1) Constant protein pool in nitrogen (193-25)
    Cnrna_variable=8*6212.59249917364        #(s) Constant for Variable part of RNA (193-26)
...
#     NP=NP[5:]
    ...
    N_pigment_m=array([ N_pigment[0], N_pigment[14], N_pigment[44], N_pigment[489], N_pigment[589]])
    N_protein_m=array([N_protein[0],N_protein[14],N_protein[44],N_protein[489],N_protein[589]])
    N_RNA_m=array([N_RNA[0],N_RNA[14],N_RNA[44],N_RNA[489],N_RNA[589]])
    N_DNA_m=array([N_DNA[0],N_DNA[14],N_DNA[44],N_DNA[489],N_DNA[589]])
    ...
    N_pigment_d=array([N_data_pig[2],N_data_pig[3],N_data_pig[7],N_data_pig[10],N_data_pig[13]])
    N_protein_d=array([N_data_pro[2],N_data_pro[3],N_data_pro[7],N_data_pro[10],N_data_pro[13]])
    N_RNA_d=array([N_data_RNA[2],N_data_RNA[3],N_data_RNA[7],N_data_RNA[10],N_data_RNA[13]])
    N_DNA_d=array([N_data_DNA[2],N_data_DNA[3],N_data_DNA[7],N_data_DNA[10],N_data_DNA[13]])
