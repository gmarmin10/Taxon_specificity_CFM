...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    Cnbiosynth=0.6*4.34728279914354E-10        #(molN cell-1 s) Constant for varible part of biosynthesis protein nitrogen (193-37)
...
#     NP=NP[5:]
    ...
    carbs_m=array([carbs[0],carbs[232],carbs[522],carbs[749],carbs[859]])
    lipids_m=array([lipids[0],lipids[232],lipids[522],lipids[749],lipids[859]])
    carb_lip_m=array([carb_lip[0],carb_lip[232],carb_lip[522],carb_lip[749],carb_lip[859]])
    pigment_m=array([pigment[0],pigment[232],pigment[522],pigment[749],pigment[859]])
    protein_m=array([protein[0],protein[232],protein[522],protein[749],protein[859]])
    RNA_m=array([RNA[0],RNA[232],RNA[522],RNA[749],RNA[859]])
    DNA_m=array([DNA[0],DNA[232],DNA[522],DNA[749],DNA[859]])
    ...
    carbs_d=array([data_carbs[3],data_carbs[8],data_carbs[9],data_carbs[12],data_carbs[14]])
    lipids_d=array([data_lip[3],data_lip[8],data_lip[9],data_lip[12],data_lip[14]])
    carb_lip_d=array([data_lip_carb[3],data_lip_carb[8],data_lip_carb[9],data_lip_carb[12],data_lip_carb[14]])
    pigment_d=array([data_pig[3],data_pig[8],data_pig[9],data_pig[12],data_pig[14]])
    protein_d=array([data_pro[3],data_pro[8],data_pro[9],data_pro[12],data_pro[14]])
    RNA_d=array([data_RNA[3],data_RNA[8],data_RNA[9],data_RNA[12],data_RNA[14]])
    DNA_d=array([data_DNA[3],data_DNA[8],data_DNA[9],data_DNA[12],data_DNA[14]])
...
#     bar(ind+width, lipids_d, width=width, label='Lipids', color='#882255', bottom=pigment_d+protein_d+RNA_d+DNA_d,edgecolor='black')
    bar(ind+width, carb_lip_d, width=width, label='Other C', color='teal', bottom=pigment_d+protein_d+RNA_d+DNA_d,edgecolor='black')
    ...
    handles=[c_leg,pig_leg,Pro_leg,RNA_leg,DNA_leg]
    
    
    #pyplot.legend(handles=handles,loc='upper center',bbox_to_anchor=(0.65,-0.35), ncol=5,fontsize='x-small',frameon=False)
