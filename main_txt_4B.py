...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    m=1.8*3.79146798299876E-19         #(mol C s-1 cell-1) maintenance carbonhydrate consumption (idea from 172-7)
    ...
    Cnrna_variable=3.5*6212.59249917364        #(s) Constant for Variable part of RNA (193-26)
