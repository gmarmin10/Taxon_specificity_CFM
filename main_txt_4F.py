...
#     NP=NP[5:]
    ...
    N_pigment_m=array([ N_pigment[0], N_pigment[249], N_pigment[560], N_pigment[699], N_pigment[929]])
    N_protein_m=array([N_protein[0],N_protein[249],N_protein[560],N_protein[699],N_protein[929]])
    N_RNA_m=array([N_RNA[0],N_RNA[249],N_RNA[560],N_RNA[699],N_RNA[929]])
    N_DNA_m=array([N_DNA[0],N_DNA[249],N_DNA[560],N_DNA[699],N_DNA[929]])
    ...
    N_pigment_d=array([N_data_pig[5],N_data_pig[6],N_data_pig[9],N_data_pig[12],N_data_pig[13]])
    N_protein_d=array([N_data_pro[5],N_data_pro[6],N_data_pro[9],N_data_pro[12],N_data_pro[13]])
    N_RNA_d=array([N_data_RNA[5],N_data_RNA[6],N_data_RNA[9],N_data_RNA[12],N_data_RNA[13]])
    N_DNA_d=array([N_data_DNA[5],N_data_DNA[6],N_data_DNA[9],N_data_DNA[12],N_data_DNA[13]])
