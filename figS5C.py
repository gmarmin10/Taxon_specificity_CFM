...
def kkI(healey85data,What_is_limiting):   #this function calculate for the same irradiance
    ...
    Cnbiosynth=1.1*4.34728279914354E-10        #(molN cell-1 s) Constant for varible part of biosynthesis protein nitrogen (193-37)
    ...
    Cnrna_variable=1.9*6212.59249917364        #(s) Constant for Variable part of RNA (193-26)
